...
> Planning provenance: this document was manually consolidated from the README,
> repository review, and independent subagent reviews. It was not generated by
> `speckit-plan`. A feature-specific Spec Kit plan should later be created under
> `specs/<feature>/`.
