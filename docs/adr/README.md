...
Architecture Decision Records capture durable technical decisions that apply
across features. Feature-specific research, limits, taxonomies, and delivery
order remain under `specs/<feature>/research.md`.
