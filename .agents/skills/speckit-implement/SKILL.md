...
4. **Project Setup Verification**:
   ...
   **If ignore file already exists**: Verify it contains essential patterns, append missing critical patterns only **If ignore
   file missing**: Create with full pattern set for detected technology
   ...
   **Common Patterns by Technology** (from plan.md tech stack):
   ...
   - **C**: `build/`, `bin/`, `obj/`, `out/`, `*.o`, `*.a`, `*.so`, `*.exe`, `*.dll`, `autom4te.cache/`, `config.status`,
