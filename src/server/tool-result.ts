...
import { SCHEMA_VERSION, type AnalysisErrorCode, type ErrorEnvelope } from "../contracts/common.js";
...
export function failedToolResult(error: unknown): CallToolResult {
	const knownError = error instanceof AnalysisToolError ? error : new AnalysisToolError("analysis_failed");
