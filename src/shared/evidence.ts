import type { EvidenceItem, EvidenceSource, RuleId } from "../contracts/common.js";
import { EvidenceItemSchema, RuleIdSchema } from "../contracts/common.js";
import { LIMITS } from "./limits.js";
import { redactSensitiveText } from "./redaction.js";

export function createOccurrenceId(ruleId: RuleId | string, occurrence: number): string {
...
export function createEvidenceItem(input: {
  ...
  const excerpt =
    input.excerpt === undefined ? undefined : redactSensitiveText(input.excerpt).slice(0, LIMITS.evidenceExcerptCharacters);
